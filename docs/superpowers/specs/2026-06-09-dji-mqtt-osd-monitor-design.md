...
DeviceManager
    ...
    │  3. 更新内存缓存
    │  4. 发出 signal: deviceOsdUpdated(deviceSn, osdData)
    ▼
OsdPanel (UI)
    │  刷新属性列表显示，变化项高亮
    ▼
...
│  └ ✈️飞机2│                                               │
│ ✈ 手飞X  │  ◆ 位置信息                                   │
│ ✈ 手飞Y  │  经度:113.412  纬度:23.058  高度:120.5m      │
│          │                                               │
│ 右键菜单 │  ◆ 飞行数据                                   │
│ 添加设备 │  电量:85%  速度:12m/s  航向:270°              │
│ 删除设备 │  飞行时间:8m32s  距home:1.2km  信号:▇▇▇▇▇   │
│ 编辑Topic│                                               │
│          │  ◆ 姿态                                       │
│ ~200px   │  Pitch:3°  Roll:2°  Yaw:270°                 │
├──────────┴──────────────────────────────────────────────┤
